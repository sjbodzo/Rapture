...
SeqBuilder.prototype = {
    ...
    initCarbonAlpha:function () {
      ...
      this.aminoAcid.atoms[1].mesh.position.x = (this.aminoAcid.atoms[1].x);
      this.aminoAcid.atoms[1].mesh.position.y = (this.aminoAcid.atoms[1].y);
      this.aminoAcid.atoms[1].mesh.position.z = (this.aminoAcid.atoms[1].z);
    },
    CarbonAlphaToR:function (stericToggle) {
      ...
      this.aminoAcid.atoms[5].mesh.position.x = (this.aminoAcid.atoms[5].x);
      this.aminoAcid.atoms[5].mesh.position.y = (this.aminoAcid.atoms[5].y);
      this.aminoAcid.atoms[5].mesh.position.z = (this.aminoAcid.atoms[5].z);
    },
    CarbonAlphaToH:function (stericToggle) {
      ...
      this.aminoAcid.atoms[2].mesh.position.x = (this.aminoAcid.atoms[2].x);
      this.aminoAcid.atoms[2].mesh.position.y = (this.aminoAcid.atoms[2].y);
      this.aminoAcid.atoms[2].mesh.position.z = (this.aminoAcid.atoms[2].z);
    },
    CarbonAlphaToCarbon:function (stericToggle) {
      ...
      this.aminoAcid.atoms[0].mesh.position.x = (this.aminoAcid.atoms[0].x);
      this.aminoAcid.atoms[0].mesh.position.y = (this.aminoAcid.atoms[0].y);
      this.aminoAcid.atoms[0].mesh.position.z = (this.aminoAcid.atoms[0].z);
    },
    CarbonToOxygen:function (stericToggle) {
      ...
      this.aminoAcid.atoms[6].mesh.position.x = (this.aminoAcid.atoms[6].x);
      this.aminoAcid.atoms[6].mesh.position.y = (this.aminoAcid.atoms[6].y);
      this.aminoAcid.atoms[6].mesh.position.z = (this.aminoAcid.atoms[6].z);
    },
    CarbonToNitrogen:function (stericToggle) {
      ...
      this.aminoAcid.atoms[3].mesh.position.x = (this.aminoAcid.atoms[3].x);
      this.aminoAcid.atoms[3].mesh.position.y = (this.aminoAcid.atoms[3].y);
      this.aminoAcid.atoms[3].mesh.position.z = (this.aminoAcid.atoms[3].z);
    },
    NitrogenToHydrogen:function (stericToggle) {
      ...
      this.aminoAcid.atoms[4].mesh.position.x = (this.aminoAcid.atoms[4].x);
      this.aminoAcid.atoms[4].mesh.position.y = (this.aminoAcid.atoms[4].y);
      this.aminoAcid.atoms[4].mesh.position.z = (this.aminoAcid.atoms[4].z);
    },
